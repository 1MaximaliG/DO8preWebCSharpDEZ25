...
namespace StringsDO8
{
    internal class Program
    {
        ...
        {
            string text = "kjfdakgaldahgäwihASDFGgld.yhöhbyjsljhägh231345###";
            Console.WriteLine(CountCharInString(text, 'ö'));
            AnalyseString(text);
            Console.WriteLine(IsPalindromAlt("Otto"));
            Console.WriteLine(IsPalindromAlt("Otter"));
            Console.WriteLine(IsPalindromAlt("Dreh mal am Herd"));
            Console.WriteLine(IsPalindrom("Dreh mal am Herd"));
            Console.WriteLine(ContainsDuplicateChars("abcc"));
            Console.WriteLine(RemoveDuplicateChars("Otter"));
            Console.WriteLine(Capitalize("OTOO lashhafh ###!! 13213 a123"));
        }
    }
}
